...
<div id="container">
	...
	<center>
		<h3>List of PlantConsulantancy</h3>
	</center>
	<div class="card">
		<div id="navbar">
			...
			echo "<table id='tbl' class='card-body table table-striped table-responsive-md btn-table'>";
			echo "<center>	
		<th class='nr'>id</th>
		<th>FarmerName</th>
		<th>Mobile_No</th>
		...
		<th style='padding-left:20px;padding-right:20px;'>Attachment</th>
			...
			while ($row = mysqli_fetch_assoc($result)) {
				...
				echo "<td>" . $row['preid'] . "</td>";


				echo "<td><input type='text' name='pay' id='pay' ><button id='insert' class='btn btn-success insert'>PayAmount</button></td>";
